    ...
    return (
        <header className='p-4 flex justify-center items-center'>
            <Link href='/' className='w-full flex justify-left items-center gap-2'>
                <Image src={Logo} alt='Synpase logo' width={25} height={25} />
            ...
            <NavigationMenu className='hidden md:block'>
                <NavigationMenuList className='gap-6'>
                    ...
                    {/* <NavigationMenuItem>
                        <NavigationMenuContent>
                            <ul className='grip-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]'>
                                {components.map((component)=>{
                                    return <ListItem key={component.title} href={component.href}>
...
>(({ className, title, children, ...props }, ref) => {
    return <li>
        <NavigationMenuLink asChild>
            <a ref={ref} className={cn('group block select-none space-y-1 font-md leading-none', className)} {...props}>
                <div className='text-white text-sm font-md leading-none'>
                    {title}
                </div>
