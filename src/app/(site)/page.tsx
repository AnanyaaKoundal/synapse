...
import Banner from '@/root/public/appBanner.png'
import Calendar from '@/root/public/cal.png'
import Diamond from '@/root/public/icons/diamond.svg'
import Check from '@/root/public/icons/check.svg'
        ...
        <>
            <section className='overflow-hidden px-4 sm:px-6 mt-10 sm:flex sm:flex-col md:justify-center md:items-center'>
                ...
                <div className='md:mt-[-90px] sm:w-full w-[750px] flex justify-center items-center mt-[-40px] relative sm:ml-0 ml-[-50px]'>
                    <Image src={Banner} alt='Description' />
            ...
            <section className='relative'>
                <div className="overflow-hidden flex after:content[''] after:dark:from-brand-dark after:to-transparent after:from-background after:bg-gradient-to-l after:right-0 after:top-0 after:bottom-0 after:w-20 after:absolute after:z-10 before:content[''] before:dark:from-brand-dark before:to-transparent before:from-background before:bg-gradient-to-r before:left-0 before:top-0 before:bottom-0 before:w-20 before:z-10 before:absolute">
                    {[...Array(2)].map((arr) => (
            ...
            <section className='px-4 sm:px-6 flex justify-center items-center flex-col relative'>
                ...
                <TitleSection
                    title='Keep track of all your tasks and projects in one place'
                    subheading='Synapse is the all-in-one collaboration and productivity platform that helps you stay organized and focused.'
                    pill='Features'
                />
                <div className='mt-10 max-w-[450px] flex justify-center items-center relative sm:ml-0 rounded-2xl border-8 border-l-washed-purple-300 border-opacity-10'>
            ...
            <section className='mt-20 px-4 sm:px-6'>
                <TitleSection
                    title='A perfect plan for you'
                    subheading='Come and enjoy the curate value deals and leverage the potential hidden inside you'
                    pill='Pricing'
                />
                        ...
                        return (<CustomCard
                                    ...
                                    cardContent = {<CardContent className='p-0'>
                                                    ...
                                                    {+card.price > 0 ? (
                                                        ...
                                                        <span className='dark:text-washed-purple-800 ml-3 text-sm'>({card.description})</span>
                                                    )}
                                                    <Button className='whitespace-nowrap w-full mt-4 text-lg font-semibold'>
